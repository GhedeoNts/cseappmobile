...
import styles from './StylesScreenSearchProfilesCandidates'
...
export default function SearchProfilesCandidates() {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.styleViewComponentSelectCandidate}>
                ...
                <View style={styles.styleComponentSelectCandidate}>
                    <SelectCandidate
                        style={styles.styleComponentSelectCandidate}
                        FullNameContent={StringAppFr.screenCandidateSearch.namesOfCandidates.candidateFour}
                        ImgSourceCandidate={ImgForApp.avatarImg.avatarScreenSearchCandidate.avatarFour}
                    />
                </View>
                ...
                <View style={styles.styleComponentSelectCandidate}>
                    <SelectCandidate
                        style={styles.styleComponentSelectCandidate}
                        FullNameContent={StringAppFr.screenCandidateSearch.namesOfCandidates.candidateFive}
                        ImgSourceCandidate={ImgForApp.avatarImg.avatarScreenSearchCandidate.avatarOne}
                    />
                </View>
                ...
                <View style={styles.styleComponentSelectCandidate}>
                    <SelectCandidate
                        style={styles.styleComponentSelectCandidate}
                        FullNameContent={StringAppFr.screenCandidateSearch.namesOfCandidates.candidateSix}
                        ImgSourceCandidate={ImgForApp.avatarImg.avatarScreenSearchCandidate.avatarFive}
                    />
                </View>
